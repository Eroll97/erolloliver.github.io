...
export default function FirstSection() {
  ...
  return (
    ...
    >
      {/* Mobile/Tablet Layout: Text first, then Lanyard - HIDDEN ON DESKTOP */}
      <div className="flex flex-col lg:hidden">
        {/* 3D Lanyard Section - Mobile/Tablet (order-1 = top) */}
        <div className="relative w-full h-80 sm:h-96 md:h-[500px] overflow-visible mb-8 order-1">
          <Lanyard
            position={[0, 0, 11]}
            gravity={[0, -40, 0]}
        ...
        {/* Text Content - Mobile/Tablet (order-2 = bottom) */}
        <div className="mt-[60vh] sm:mt-[40vh] md:mt-96 px-4 sm:px-8 md:px-16 w-full text-center pb-8 order-2 min-h-[50vh] flex flex-col justify-center">
          <h1
      ...
      {/* Desktop Layout: Side by Side - HIDDEN ON MOBILE/TABLET */}
